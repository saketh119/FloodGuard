...
export default function Predictions() {
  ...
  const forecast = (payload?.observations?.forecast ? [payload.observations.forecast.raw] : []);
  ...
  return (
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        ...
        <p className={styles.subtitle}>Basin QPF + 7-day city forecast for {location.district}, {location.state}</p>
      </div>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionSub}>Quantitative Precipitation Forecast from IMD basin data · {(location.basin ? `${location.basin} basin` : 'river basin')} basin</p>
